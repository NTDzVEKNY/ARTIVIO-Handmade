                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h1 className="text-xl font-bold flex flex-wrap items-center gap-2 text-[#0f172a]">
                                    {chat.title}
                                    <span className="text-xs font-normal px-2 py-0.5 bg-gray-100 rounded-full text-gray-500 border border-gray-200">
                                        ID: {chatId}
                                    </span>
                                </h1>
                        ...
                        <div className="flex flex-col md:flex-row gap-6">
                            ...
                            {hasReferenceImage && (
                                <div className="md:w-64 flex-shrink-0">
                                    ...
                                    <div className="relative w-full h-40 md:h-44 rounded-lg overflow-hidden border border-gray-200 bg-white shadow-sm group">
                                        {/* @ts-ignore */}
                                        <Image
                            ...
                            <div className={`flex-1 flex flex-col justify-between gap-4 ${hasReferenceImage ? 'md:border-l md:border-gray-200 md:pl-6' : ''}`}>
                                <div>
                                ...
                                <div className="flex items-center justify-between md:justify-end border-t pt-3 md:border-t-0 md:pt-0">
                                    ...
                                    <div className="text-base font-bold text-green-600 bg-green-50 px-3 py-1 rounded-lg border border-green-100">
                                        {/* @ts-ignore */}
                                        ...
                                        <div className={`rounded-2xl px-4 py-2 shadow-sm ${isMe ? 'bg-[#0f172a] text-white rounded-br-none' : 'bg-gray-100 text-gray-800 rounded-bl-none'}`}>
                                            {message.is_image ? (
                                                <div className="relative w-full min-w-[200px] h-48 rounded-lg overflow-hidden mb-2 bg-gray-300">
                                                    <Image src={getFullImageUrl(message.content)} alt="Message image" fill className="object-cover" onClick={() => window.open(getFullImageUrl(message.content), '_blank')} />
                                                </div>
                                            ) : (
                        ...
                        <>
                            ...
                            <div className="flex gap-2 items-end">
                                ...
                                <div className="flex-1 relative">
                                    <Input type="text" value={messageText} onChange={(e) => setMessageText(e.target.value)} onKeyPress={handleKeyPress} placeholder="Nhập tin nhắn..." disabled={sending} className="rounded-full pr-10 focus-visible:ring-slate-900" />
                                </div>
