    ...
    return (
        <main className="container mx-auto px-6 py-12"
            ...
            <div className="mb-12 text-center">
                ...
                <p className="text-lg" style={{color: '#6B4F3E'}}>Khám phá bộ sưu tập sản phẩm thủ công độc đáo của
                    chúng tôi</p>
            </div>
                            ...
                            {PRICE_RANGES.map((range) => (
                                <label key={range.id}
                                    ...
                                    <input
                                        ...
                                        className="w-4 h-4"
                                    />
                                    <span className={`text-sm ${priceRange === range.id ? 'font-semibold' : ''}`}
                                          style={{color: priceRange === range.id ? '#D96C39' : '#3F2E23'}}>
                    {range.label}
                  </span>
                                </label>
                            ))}
                ...
                <div className="md:col-span-3">
                    ...
                    {pageItems.length > 0 ? (
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    {isProductOutOfStock(product) && (
                                                        <div
                                                            className="absolute top-3 left-3 bg-red-600 text-white px-3 py-1.5 rounded-full text-xs font-bold shadow-lg z-10">
                                                            Hết hàng
                                                        </div>
                                                    )}
                                                ...
                                                {/* Content */}
                                                <div
                                                    className="p-5 flex-1 flex flex-col pointer-events-none relative z-10">
                                                    ...
                                                    <p className="text-xs mt-1 line-clamp-2 mb-4 flex-grow"
                                                       style={{color: '#6B4F3E'}}>
                                                        {product.description}
                                                    </p>
                                                    <div className="flex items-center justify-between pt-4 relative"
                                                        ...
                                                        <div
                                                            className={`absolute right-0 flex items-center gap-1 transition-opacity duration-300 pointer-events-auto ${isProductOutOfStock(product) ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'}`}>
                                                            {isProductOutOfStock(product) ? (
                                                                <div
                                                                    className="px-3 py-1.5 rounded-full text-white shadow-md flex items-center gap-1 text-[10px] font-medium cursor-not-allowed"
                                                                ...
                                                                <>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <span
                                                                            className="whitespace-nowrap">Thêm vào giỏ</span>
                                                                    </button>
                                                                    <button
                                                                        type="button"
                                                                        title="Mua ngay"
                                                                    ...
                                                                    >
                                                                        <CreditCard size={12}/>
                                                                        <span
                                                                            className="whitespace-nowrap">Mua ngay</span>
                                                                    </button>
                                                                </>
                                                            )}
                                                        </div>
                            ...
                            <div className="mt-12 flex items-center justify-center gap-2 pb-8 w-full">
                                ...
                                {Array.from({length: totalPages}).map((_, i) => {
                                    ...
                                    if (!show) {
                                        ...
                                        if (leftGap || rightGap) {
                                            return <span key={`gap-${i}`} className="px-2 font-medium"
                                                         style={{color: '#D96C39'}}>…</span>;
                                        }
                                        return null;
                                    }
                                    return (
                        ...
                        <div className="text-center py-20">
                            ...
                            <h3 className="text-2xl font-semibold mb-3" style={{color: '#3F2E23'}}>Không tìm thấy sản
                                phẩm</h3>
